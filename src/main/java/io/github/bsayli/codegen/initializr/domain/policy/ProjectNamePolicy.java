...
import io.github.bsayli.codegen.initializr.domain.policy.rule.ReservedNamesRule;
...
public final class ProjectNamePolicy {
  ...
  private static final Pattern ALLOWED = Pattern.compile("^[a-z][a-z0-9-]{2,39}$");
  ...
  private static void validate(String value) {
    Rule<String> rule =
        CompositeRule.of(
            ...
            new RegexMatchRule(ALLOWED, PROJECT_NAME, INVALID_CHARS),
            new ReservedNamesRule(RESERVED, PROJECT_NAME));
    rule.check(value);
  }
}
